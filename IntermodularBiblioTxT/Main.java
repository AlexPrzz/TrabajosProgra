...
public class Main {
    ...
    private static void printMenu() {
        ...
        System.out.println("6. Guardar información en archivo TXT");
    ...
    private static void guardarInformacionEnArchivo() {
        String rutaArchivo = "C:\\Users\\aleja\\OneDrive\\Escritorio\\IntermodularBiblio\\autores.txt";
        ...
        try (BufferedWriter writer = new BufferedWriter(new FileWriter(rutaArchivo))) {
            ...
            if (arrayAutor.getAutores().isEmpty()) {
                writer.write("  <!-- Este archivo XML está vacío, introduce datos para generar un archivo válido -->");
                writer.newLine();
            } else {
                for (Autor autor : arrayAutor.getAutores()) {
                    writer.write("  <Autor>");
                    writer.newLine();
                    writer.write("    <ID>" + autor.getIdAutor() + "</ID>");
                    writer.newLine();
                    writer.write("    <Nacionalidad>" + autor.getNacionalidad() + "</Nacionalidad>");
                    writer.newLine();
                    writer.write("    <Premios>" + autor.getPremios() + "</Premios>");
                    writer.newLine();
                    writer.write("    <Nombre>" + autor.getNombre() + "</Nombre>");
                    writer.newLine();
                    writer.write("    <Apellido1>" + autor.getApellido1() + "</Apellido1>");
                    writer.newLine();
                    writer.write("    <Apellido2>" + autor.getApellido2() + "</Apellido2>");
                    writer.newLine();
                    writer.write("  </Autor>");
                    writer.newLine();
                }
            ...
            writer.write("</Autores>");
            writer.newLine();
            System.out.println("Informe XML guardado exitosamente en: " + rutaArchivo);
        } catch (IOException e) {
